const list_of_topics = {
    ...
    "Movies_and_TV_Shows": ["התחלה", "טיטאניק", "חברים", "שובר שורות", "הסנדק", "האביר-אפל", "משחקי-הכס", "משפחת-סימפסון", "דברים-מוזרים", "הארי-פוטר", "מלחמת-הכוכבים", "שר-הטבעות", "הנוקמים", "שרלוק", "המשרד"]
};
